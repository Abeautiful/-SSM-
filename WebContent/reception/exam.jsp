									...
									<c:if test="${esm.subject.subjectType == 0 }">
										<p class="aswer-p">
											<input class="aswer-option"
												...
												value="A" />
											&nbsp;
											<span class="subjectOption">${esm.subject.optionA }</span>
										</p>
										<p class="aswer-p">
											<input class="aswer-option"
												...
												value="B" />
											&nbsp;
											<span class="subjectOption">${esm.subject.optionB }</span>
										</p>
										<p class="aswer-p">
											<input class="aswer-option"
												...
												value="C" />
											&nbsp;
											<span class="subjectOption">${esm.subject.optionC }</span>
										</p>
										<p class="aswer-p">
											<input class="aswer-option"
												...
												value="D" />
											&nbsp;
											<span class="subjectOption">${esm.subject.optionD }</span>
										</p>
									</c:if>
									<%-- 多选 --%>
