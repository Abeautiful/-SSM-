								...
								<div class="col-md-4">
									<div class="thumbnail">
										...
										<div class="caption">
											...
											<p>
												考试科目: ${ep.course.courseName }
												&emsp;
												&emsp;
												考试时长: <span id="examPaperTime${ep.examPaper.examPaperId }">${ep.examPaper.examPaperTime }</span>
												分钟
											</p>
											<p>
												题目数量: ${ep.examPaper.subjectNum }
												&emsp;
												&emsp;
												总分: ${ep.examPaper.examPaperScore }
												&emsp;
												&emsp;
												难易程度:
